...
export function Skills() {
  return (
    <div 
      ...
      className="relative min-h-screen bg-black text-zinc-100 flex flex-col items-center justify-center p-4 md:p-8 overflow-hidden font-sans"
    >
      ...
      >
        ...
        <div id="blueprint-header-row" className="flex border-b border-zinc-800/80">
          ...
          >
            <span 
              id="header-tag"
              className="font-mono text-[9px] md:text-[10px] font-bold tracking-[0.25em] text-zinc-500"
            >
